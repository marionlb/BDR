...
public class Intersection extends NAryRelation implements Cloneable
{
	...
	protected class IntersectionIterator extends NAryRelationStreamIterator
	{
		...
		/**
		 * Implementation of internalNext. This implementation assumes that the
		 * relations it draws its tuples from are sorted.
		 */
		@Override
		...
		/**
		 * Determines if the tuples currently held in the tuple vector are all
		 * equal
		 *
		 * @return True if the tuples are all equal and not null, false
		 * otherwise
		 */
