...
public class QueryTranslator {
    ...
    private static void jointures() {
         ...
         */
        Iterator<Entry<String, VariableTable>> it       = tables.entrySet().iterator();
            ...
            while (itc.hasNext()) {
                ...
                if (c instanceof Equality) {
                    ...
                    if (tab != null) {
                        ...
                        // tables ?
                        boolean cond = (tab[0].equals(next.getName()) && dejaJoin.contains(tab[1])
                                        &&!dejaJoin.contains(tab[0])) || (tab[1].equals(next.getName())
                                            && dejaJoin.contains(tab[0]) &&!dejaJoin.contains(tab[1]));
    ...
    private static String readFile(String path) throws IOException {
        ...
        try {
            ...
            return Charset.defaultCharset().decode(bb).toString().replace(System.getProperty("line.separator"), "");
        } finally {
            stream.close();
        }
    }
